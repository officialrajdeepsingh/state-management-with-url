      ...
      <div className="grid grid-cols-1">
        <div className="w-full max-w-lg mx-auto my-4 bg-white shadow-xl rounded-xl">
          ...
          <div className="p-6 lg:text-center">
            <h4 className="mt-8 text-2xl font-semibold leading-none tracking-tighter text-neutral-600 lg:text-3xl">Search Results for {searchParams?.name} </h4>
            <p className="mt-3 text-base leading-relaxed text-gray-500">Age {searchParams?.age}.</p>
          </div>
        </div>
      </div>
    </section>
